    ...
    public void received(Connection connection, Object object) {
        if (object instanceof ClientsZug zug) {
            ...
            if(sp.zustand == sp.minispielZustand){
                ...
                switch (bewegung.richtung) {
                    case "oben" -> sp.alleSpieler.get(bewegung.clientIndex).spielfigur.richtung = "oben";
                    case "unten" -> sp.alleSpieler.get(bewegung.clientIndex).spielfigur.richtung = "unten";
                    case "rechts" -> sp.alleSpieler.get(bewegung.clientIndex).spielfigur.richtung = "rechts";
                    case "links" -> sp.alleSpieler.get(bewegung.clientIndex).spielfigur.richtung = "links";
                    case "stehen" -> sp.alleSpieler.get(bewegung.clientIndex).spielfigur.richtung = "stehen";
                }
                sp.alleSpieler.get(bewegung.clientIndex).zuStern = bewegung.zustern;
            ...
            ArrayList<Boolean> allePaletteFalle = new ArrayList<>();
            allePaletteFalle.add(palettenFalle.palette0);
            allePaletteFalle.add(palettenFalle.palette2);
            allePaletteFalle.add(palettenFalle.palette4);
            allePaletteFalle.add(palettenFalle.palette6);
            allePaletteFalle.add(palettenFalle.palette8);
            allePaletteFalle.add(palettenFalle.palette10);
            allePaletteFalle.add(palettenFalle.palette12);
            sp.minispielManager.squidGame.falleFestlegen(allePaletteFalle);
        }
    }
}
