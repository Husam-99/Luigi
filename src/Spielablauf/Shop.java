...
public class Shop {
    ...
    //temporäre Gegenstände nur für Bilder Zugriff
    ...
    public void gegenstandKaufen(){
        ...
        //wenn der Spieler genug Münzen hat, dann der Gegenstand SternTaxi kaufen
        if(befehlNum == 0){
        ...
        //wenn der Spieler genug Münzen hat, dann der Gegenstand Repos kaufen
        else if(befehlNum == 1){
        ...
        //wenn der Spieler genug Münzen hat, dann der Gegenstand Bube kaufen
        else if(befehlNum == 2){
        ...
        //wenn der Spieler genug Münzen hat, dann der Gegenstand Block kaufen
        else if(befehlNum == 3){
        ...
        //wenn der Spieler genug Münzen hat, dann der Gegenstand Megawürfel kaufen
        else if(befehlNum == 4){
        ...
        //wenn der Spieler genug Münzen hat, dann der Gegenstand Miniwürfel kaufen
        else if(befehlNum == 5){
    ...
    private void preisMalen(){
        g2.drawImage(spielablaufManager.mapManager.muenze.muenze, 350, 430, spielablaufManager.sp.vergroesserteFliesenGroesse, spielablaufManager.sp.vergroesserteFliesenGroesse, null);
        g2.drawImage(spielablaufManager.mapManager.muenze.muenze, 650, 430, spielablaufManager.sp.vergroesserteFliesenGroesse, spielablaufManager.sp.vergroesserteFliesenGroesse, null);
        g2.drawImage(spielablaufManager.mapManager.muenze.muenze, 950, 430, spielablaufManager.sp.vergroesserteFliesenGroesse, spielablaufManager.sp.vergroesserteFliesenGroesse, null);
        g2.drawImage(spielablaufManager.mapManager.muenze.muenze, 350, 630, spielablaufManager.sp.vergroesserteFliesenGroesse, spielablaufManager.sp.vergroesserteFliesenGroesse, null);
        g2.drawImage(spielablaufManager.mapManager.muenze.muenze, 650, 630, spielablaufManager.sp.vergroesserteFliesenGroesse, spielablaufManager.sp.vergroesserteFliesenGroesse, null);
        g2.drawImage(spielablaufManager.mapManager.muenze.muenze, 950, 630, spielablaufManager.sp.vergroesserteFliesenGroesse, spielablaufManager.sp.vergroesserteFliesenGroesse, null);
